...
Story1::Story1(SDL_Renderer* renderer)
...
void Story1::handleEvent(SDL_Event& e) {
...
void Story1::update(double deltaTime) {
    // 更新劇情邏輯
}

void Story1::render(SDL_Renderer* renderer) {
...
void Story1::wrapText(const string& text, int maxWidth) {
